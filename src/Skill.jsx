          ...
          <Grid container>
            <Grid lg={5} md={10} xs={11} item sx={{ position: "relative" }}>
              <Box sx={{ transition: "all 4s ease-in" }}>
                ...
                />
                <Card sx={{ paddingX: 2, marginX: 2, paddingY: 1, zIndex: 7 }}>
                  <Typography
                    sx={{ marginY: 1, fontSize: 20, fontWeight: "bold" }}
                  >
                  ...
                  >
                    April 2024 - Apri 2025
                  </Typography>
                  <Typography sx={{ color: "gray", marginY: 2 }}>
                    Full Stack Web Developer At Skillhub UI/UX Designer & MERN
                    Stack Developer
                  </Typography>
                </Card>
                <Box sx={{ marginTop: 4 }}>
                  ...
                  />
                  <Card
                    sx={{ paddingX: 2, marginX: 2, paddingY: 2, zIndex: 7 }}
                  >
                    <Typography
                      sx={{ marginY: 1, fontSize: 20, fontWeight: "bold" }}
                    >
                    ...
                    <Typography sx={{ color: "gray", marginY: 1 }}>
                      Rajarshi Shree Shahu Arts, Commerce & Science College
                      Pathri Tq. Phulambri Dist. Sambhajinagar
                    </Typography>
                  </Card>
                </Box>
              </Box>
            ...
            <Grid
              container
              sx={{ marginY: 3, display: { sm: "block", md: "none" } }}
            >
              <Grid item md={6} xs={12}>
                <Typography
                  sx={{
            ...
            <Grid
              ...
              xs={11}
              item
              sx={{ position: "relative", marginTop: { xs: 0, lg: 0, sm: 3 } }}
            >
              <ForwardIcon
                sx={{
                  position: "absolute",
              ...
              <Card sx={{ paddingX: 2, marginX: 2, paddingY: 2, zIndex: 7 }}>
                <Box sx={{ display: "flex" }}>
                  ...
                  <Typography sx={{ marginY: 1 }}>
                    SHUBHAM SAKHARAM TUPE
                  </Typography>
                </Box>
                <Box sx={{ display: "flex" }}>
                  <Typography sx={{ marginY: 0, fontWeight: "bold" }}>
                    Age :{" "}
                  </Typography>
                  <Typography sx={{ marginY: 0, marginLeft: 1 }}>21</Typography>
                </Box>
                <Box sx={{ display: "flex" }}>
                  <Typography sx={{ marginY: 1, fontWeight: "bold" }}>
                    City :{" "}
                  </Typography>
                  <Typography sx={{ marginY: 1, marginLeft: 1 }}>
                ...
                <Box sx={{ display: "flex" }}>
                  ...
                  <Typography sx={{ marginY: 1, marginLeft: 1 }}>
                    Aadgaon Tq. Phulambri Dist. Sambhajinagar
                  </Typography>
                </Box>
              </Card>
              <Box sx={{ marginTop: 4 }}>
